...
In this part, we first make several maps to have a quick view about global forest loss in world wide and different tropical forest region.
```{r, echo=TRUE}
#做地圖
...
AO.predominant.plot
```
In order to visualize the composition of forest loss in different region, we use bar plot to examine them
```{r, echo=TRUE}
#三大洲的範圍 用於各大洲的柱狀圖使用
