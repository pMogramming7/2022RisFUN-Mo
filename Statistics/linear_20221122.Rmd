...
knitr::purl('linear_20221122.Rmd', documentation = F)
```
...
xfun::embed_file('linear_20221122.Rmd')
```

```{r echo=FALSE, purl=F}
xfun::embed_file('linear_20221122.R')
```
...
![](D:/R_WD/Git linked/2022RisFUN-Mo/Statistics/linear-regression.png){width=50%}
...
![](D:/R_WD/Git linked/2022RisFUN-Mo/Statistics/boot.gif){width=50%}
...
![](D:/R_WD/Git linked/2022RisFUN-Mo/Statistics/LOOCV.gif){width=50%}
...
![](D:/R_WD/Git linked/2022RisFUN-Mo/Statistics/KfoldCV.gif){width=50%}
